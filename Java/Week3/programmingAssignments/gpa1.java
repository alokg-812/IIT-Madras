...
class Employee extends Person{
    ...
    // override print to include salary
    @Override
    public void print() {
        super.print();
...
class ContactEmployee extends Employee {
    ...
    // constructor: compute salary as contactHour * hourlyPay
    public ContactEmployee(String name, long aadharno, int contactHour) {
        // compute salary and call parent constructor
        super(name, aadharno, contactHour * hourlyPay);
        this.contactHour = contactHour;
    }

    // (no need to override print here; Employee.print already prints salary
    // and super.print() will print name and aadharno)
}
